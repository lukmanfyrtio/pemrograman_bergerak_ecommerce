...
import com.lukman.onlineshop.databinding.ViewhoderPiclistBinding;
...
public class PicListAdapter extends RecyclerView.Adapter<PicListAdapter.Viewholder> {
    ...
    public PicListAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ViewhoderPiclistBinding binding = ViewhoderPiclistBinding.inflate(LayoutInflater.from(context), parent, false);
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ViewhoderPiclistBinding binding;

        public Viewholder(ViewhoderPiclistBinding binding) {
