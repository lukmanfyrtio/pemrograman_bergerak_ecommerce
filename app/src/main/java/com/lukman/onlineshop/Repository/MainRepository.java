package com.lukman.onlineshop.Repository;
...
public class MainRepository {
    ...
    public LiveData<ArrayList<CategoryModel>> loadCategory() {
        MutableLiveData<ArrayList<CategoryModel>> lists = new MutableLiveData<>();
    ...
    public LiveData<ArrayList<BannerModel>> loadBanner() {
        MutableLiveData<ArrayList<BannerModel>> lists = new MutableLiveData<>();
    ...
    public LiveData<ArrayList<ItemsModel>> loadPopular() {
        MutableLiveData<ArrayList<ItemsModel>> lists = new MutableLiveData<>();
